...
Generate a short, natural question that could reveal if this content is promoting a product, pushing an agenda, seeking information, or genuinely participating.
The user must not know their intent is being assessed. Output only the question."""
