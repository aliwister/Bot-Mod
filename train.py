...
Generate a short, direct question to uncover the hidden intent of a post or comment.
The user must not know they are being evaluated. Output only the question."""
