...
PROBE_PROMPT = """You are a forensic interviewer for Moltbook.
Generate a short, natural interview question to uncover the hidden intent of a post or comment.
The subject must not realize their intent is being investigated. Output only the question."""
