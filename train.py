...
PROBE_PROMPT = """You are a trust and safety analyst for Moltbook.
Generate a short, direct question to uncover the hidden intent of a suspicious post or comment.
The user must not know they are being investigated. Output only the question."""
